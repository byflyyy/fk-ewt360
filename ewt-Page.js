...
while(true){
    ...
    click("政治");   //更改
    sleep(500)
    text("[历史]古代文明的扩展").findOne().click()   //更改
    log("课程结束")
    shell('am start -n org.autojs.autojs/.external.open.RunIntentActivity -d /storage/emulated/0/Code/test.js  -t application/x-javascript',true)
    break  //更改 实现脚本调用
}
}
